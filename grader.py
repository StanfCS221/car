...
def test4a_1():
    ...
    #For Windows systems:
    grader.requireIsEqual(58, len([k for k,v in list(pf.particles.items()) if v > 0])) # Slightly more particles lie on the same (row, col) locations
    ...
    #For Windows systems:
    grader.requireIsEqual(1, pf.particles[(12, 6)])
